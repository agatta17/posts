<template>
  <div class="post container">
    ...
    <p class="post__description" v-if="post.body">{{post.body}}</p>
    <button class="post__edit-btn" v-if="post.body">
    ...
    <h1 class="post__stub" v-if="!post.title && !post.body">Пост не найден</h1>
